...
try {
    ...
    $pdo->exec("INSERT INTO pending_price_approvals (station_id, product_type, product_id, old_cost, new_cost, old_price, new_price, manager_id, status) VALUES (1253, 'fuel_inventory', 6, 85.00, 85.00, 85.00, 88.50, 1, 'pending')");
    
    // Check if there's merchandise to add a mock for station 1253
