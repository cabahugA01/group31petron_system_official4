...
<div class="int-head">
    <div>
        <h1><i class="fas fa-clock"></i> Shift Transactions</h1>
        <div class="sub">Track and compare transaction activities, sales performance, and collections per shift.</div>
    </div>
    <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
        <a href="transactions.php" style="display:inline-flex;align-items:center;gap:6px;padding:0 16px;background:#fff !important;color:#4b5563 !important;border:1px solid #6b7280 !important;border-radius:7px;text-decoration:none;font-size:13px;font-weight:600;transition:all .15s;height:36px;box-sizing:border-box;align-items:center;line-height:34px;" onmouseover="this.style.background='#6b7280 !important';this.style.color='#fff !important';" onmouseout="this.style.background='#fff !important';this.style.color='#4b5563 !important';">
