...
<body>
    ...
    <div class="login-wrap">
        <div class="login-card">
            <div class="brand">
                <img src="<?php echo htmlspecialchars('../' . get_system_logo_url(isset($station_id) ? (int)$station_id : (isset($user['station_id']) ? (int)$user['station_id'] : 0))); ?>" alt="Petron Logo" class="brand-logo" onerror="this.onerror=null;this.src='../assets/img/Petron%20Logo.png';">
