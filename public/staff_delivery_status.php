...
$flash_messages = [
    'received'     => '&#10003; Delivery received and submitted for Manager Validation. Check status below.',
    'discrepancy'  => '&#9888; Variance detected! Delivery was flagged for Manager review. Please monitor status.',
    'manual_saved' => '&#10003; Manual delivery saved successfully and submitted for Manager Validation.',
    'resubmitted'  => '&#10003; Delivery resubmitted successfully. Awaiting Manager Validation.',
];
...
/* ── Fetch Deliveries Encoded by Staff ── */
$deliveries = [];
$counts = [
    'pending'  => 0,
    'approved' => 0,
...
<div class="page-head">
    <div>
        <h1 class="h1"><i class="fas fa-clipboard-check"></i> Delivery Status</h1>
        <div class="sub">Monitor encoded deliveries: Pending Validation, Approved, or Rejected status with Manager feedback.</div>
    </div>
...
<div class="del-card">
    <div class="del-card-head">
        <div class="del-card-title">
            <i class="fas fa-list"></i> My Delivery Records
        </div>
        <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
            <span style="font-size: 13px; color: #6c757d;"><?php echo count($deliveries); ?> record(s)</span>
            <a href="staff_record_delivery.php" style="background:#002F70;color:#fff;border:none;padding:8px 16px;border-radius:6px;font-size:12px;font-weight:600;text-decoration:none;display:inline-flex;align-items:center;gap:6px;">
    ...
    <div class="del-card-body">
        <?php if (empty($deliveries)): ?>
            <div class="empty-state">
                ...
                <p>No delivery records found. Start by recording a delivery receipt.</p>
                        ...
                        <tr class="<?php echo $row_class; ?>">
                            ...
                            <td>
                                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                                    ...
                                    <?php if ($is_rejected): ?>
                                    <a href="staff_record_delivery.php?edit=<?php echo (int)$d['id']; ?>" class="btn-resubmit" title="Edit and resubmit">
...
function viewDelivery(id) {
    ...
    if (isRejected && d.manager_notes) {
        html += '<div class="rejection-banner">'
              ...
              + '<br><span style="font-size: 12px;">Please correct the details and resubmit via the "Record Delivery Receipt" page.</span>'
              + '</div></div>';
    }
    ...
    html += '<table class="detail-table">'
          ...
          + '<tr><td>Product</td><td>' + escHtml(d.product) + '</td></tr>'
    ...
    actions.innerHTML = '';
    if (isRejected) {
        actions.innerHTML += '<a href="staff_record_delivery.php?edit=' + id + '" class="btn-resubmit" style="padding: 10px 20px;">'
