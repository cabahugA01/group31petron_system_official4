...
if ($export_type === 'csv') {
    ...
    fputcsv($out, ['Txn ID', 'Customer', 'Type', 'Items / Service', 'Amount', 'Payment Method', 'Payment Status', 'Date', 'Staff', 'Validated By', 'Validation Remarks']);
    foreach ($rows as $r) {
        fputcsv($out, [
            $r['txn_id'],
            $r['customer'],
...
if ($export_type === 'excel') {
    ...
    echo '<table><thead><tr>';
    foreach (['Txn ID', 'Customer', 'Type', 'Items / Service', 'Amount', 'Payment Method', 'Payment Status', 'Date', 'Staff', 'Validated By', 'Validation Remarks'] as $h) {
...
<div class="int-head">
    <div>
        <h1><i class="fas fa-check-double"></i> All Transactions</h1>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;margin-bottom:18px;">
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;box-shadow:0 1px 4px rgba(0,0,0,.05);">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#64748b;"><i class="fas fa-receipt" style="margin-right:5px;"></i>Total Transactions</div>
        <div style="font-size:26px;font-weight:800;color:#002F70;line-height:1.1;margin-top:4px;"><?php echo count($rows); ?></div>
    </div>
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;box-shadow:0 1px 4px rgba(0,0,0,.05);">
        ...
        <div style="font-size:26px;font-weight:800;color:#0369a1;line-height:1.1;margin-top:4px;"><?php echo $merch_count; ?></div>
    </div>
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;box-shadow:0 1px 4px rgba(0,0,0,.05);">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#64748b;"><i class="fas fa-wrench" style="margin-right:5px;"></i>Job Orders</div>
        <div style="font-size:26px;font-weight:800;color:#7c3aed;line-height:1.1;margin-top:4px;"><?php echo $jo_count; ?></div>
    </div>
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;box-shadow:0 1px 4px rgba(0,0,0,.05);">
        ...
        <div style="font-size:26px;font-weight:800;color:#16a34a;line-height:1.1;margin-top:4px;"><?php echo $paid_count; ?></div>
    </div>
    <div style="background:#fff;border:1px solid #e2e8f0;border-radius:10px;padding:14px 16px;box-shadow:0 1px 4px rgba(0,0,0,.05);">
        ...
        <div style="font-size:26px;font-weight:800;color:#dc2626;line-height:1.1;margin-top:4px;"><?php echo $unpaid_count; ?></div>
    </div>
    <div style="background:linear-gradient(135deg,#002F70 0%,#003d8a 100%);border-radius:10px;padding:14px 16px;box-shadow:0 1px 4px rgba(0,0,0,.08);">
        ...
        <div style="font-size:20px;font-weight:800;color:#fff;line-height:1.1;margin-top:4px;white-space:nowrap;">&#8369;<?php echo number_format($total_amount, 2); ?></div>
    </div>
</div>
...
/* == Shared export/action buttons (outline style) == */
.txn-btn {
    display: inline-flex;
    align-items: center;
...
.txn-btn.success { color: #1d6f42 !important; border-color: #1d6f42 !important; }
.txn-btn.success:hover { background: #1d6f42 !important; color: white !important; }
