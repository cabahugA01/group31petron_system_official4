...
<div class="page-head txn-page-head">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
        ...
        <button class="flt-btn flt-btn-pdf" onclick="exportPrintableAreaToPDF('.card-table-wrap','Transaction Adjustments Oversight','transaction_adjustments_<?=htmlspecialchars($date_from)?>_to_<?=htmlspecialchars($date_to)?>',this)"><i class="fas fa-file-pdf"></i> Export PDF</button>
