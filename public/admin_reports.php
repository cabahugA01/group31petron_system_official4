<?php
/**  * Complete Admin Reports - Real Report Format  * Operations Reports with tabbed interface  * Design matches Staff Reports professional layout  */  $page_id = 'admin_reports';
require_once __DIR__ . '/../backend/lib.php';
require_once __DIR__ . '/db_connect.php';
require_login();  $me = current_user();
$role = role_key($me['role'] ?? '');
$station_id = user_station_id();  // Check if admin role
if ($role !== 'admin') {  die('Access denied. Only administrators can view this page.');
}  // Get active tab from URL parameter
$active_tab = $_GET['tab'] ?? 'shift_reports';  // Admin operational reports default to the current day so stale dates do not appear by default.
...
?>  <style>
/* ============================================================  ADMIN REPORTS - MATCHES STAFF REPORTS PROFESSIONAL DESIGN  Force application with !important for specificity  ============================================================ */  /* Main Container */
...
.rpt-page-header {  background: linear-gradient(135deg, #00264D 0%, #003d7a 100%) !important;  padding: 24px 28px !important;  color: white !important;  border-bottom: 3px solid #CC0000 !important;
...
}  .rpt-tab-btn.active {  background: white !important;  color: #00264D !important;  border-bottom-color: #CC0000 !important;  font-weight: 700 !important;
...
.rpt-export-btn:nth-child(2) {  color: #1e40af !important;  border-color: #1e40af !important;
}
.rpt-export-btn:nth-child(2):hover {  background: #dbeafe !important;  border-color: #1e3a8a !important;
...
}  .rpt-table thead {  background: #f8f9fa !important;  border-top: 2px solid #00264D !important;  border-bottom: 2px solid #e2e8f0 !important;
}  .rpt-table thead th {  padding: 12px 10px !important;  text-align: left !important;  font-weight: 700 !important;  color: #00264D !important;  font-size: 11px !important;  text-transform: uppercase !important;  letter-spacing: 0.3px !important;
