...
<div class="reports-wrapper">
    ...
    <div class="rpt-content">
        ...
        $tab_icons = [
            ...
            'user_activity_logs'   => 'fas fa-user-clock',
            'transaction_logs'     => 'fas fa-receipt',
            'inventory_logs'       => 'fas fa-clipboard-list',
            'approval_logs'        => 'fas fa-stamp',
            'archived_logs'        => 'fas fa-archive',
        ];
        ?>
