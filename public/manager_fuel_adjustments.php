...
<div class="mfa-wrap">
    ...
    <div class="int-head">
        ...
        <div style="display: flex; gap: 8px; align-items: center; flex-wrap: wrap;">
            ...
            <button type="button" onclick="exportPrintableAreaToPDF('.afto-table-card','Manager Fuel Adjustment History','manager_fuel_adjustments_<?= htmlspecialchars($date_from) ?>_to_<?= htmlspecialchars($date_to) ?>',this)" class="ato-btn ato-btn-pdf"><i class="fas fa-file-pdf"></i> Export PDF</button>
