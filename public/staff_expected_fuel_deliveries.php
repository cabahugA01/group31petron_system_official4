...
foreach ($expected_fuel_deliveries as $ed) {
...
<div class="page-head">
    <div>
        ...
        <div class="sub">View fuel purchase orders created by Manager/Admin with expected fuel types and quantities.</div>
    </div>
...
<div class="summary-grid">
    <div class="summary-card sc-blue" style="position:relative;">
        <i class="fas fa-truck sc-icon"></i>
...
<!-- Expected Fuel Deliveries Card -->
<div class="del-card">
    <div class="del-card-head">
        <div class="del-card-title">
            <i class="fas fa-truck-loading"></i> Expected Fuel Deliveries
    ...
    <div class="del-card-body">
        <?php if (empty($expected_fuel_deliveries)): ?>
            <div class="empty-state">
                ...
                <p>No expected fuel deliveries at the moment.</p>
            ...
            <div class="expected-item">
                <div class="expected-info">
                    ...
                    <div class="expected-meta">
                        ...
                        <span><i class="fas fa-gas-pump"></i> Expected: <strong><?php echo number_format($ed['quantity'], 2) . ' ' . $ed['unit']; ?></strong></span>
