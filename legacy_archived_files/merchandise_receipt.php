...
$staffID = isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'STAFF001';

// Get station info
$stationInfo = [
    'dealer' => 'PETRON STATION MANAGEMENT SYSTEM',
    'branch' => 'VAMENTA BLVD., CARMEN, CAGAYAN DE ORO CITY, MISAMIS ORIENTAL',
    'vat_tin' => '236-002-207-0000'
];

// Sample transaction data (in real implementation, this would come from database)
$transactionData = [
    'customer_name' => isset($_GET['customer']) ? $_GET['customer'] : 'Walk-in Customer',
    'payment_method' => isset($_GET['payment']) ? $_GET['payment'] : 'Cash',
    'items' => [
        [
            'description' => 'COKE BOTTLE 1L',
            'category' => 'SOFTDRINKS',
            'sku' => '8800123456789',
            'size' => '1L',
            'qty' => 1,
...
// Calculate VAT
$vatCalculation = calculateVAT($transactionData['grand_total']);
?>
...
<head>
    ...
    <title>Petron Merchandise Transaction</title>
    <style>
        @media print {
...
<body>
    <div class="receipt-container">
        ...
        <div class="header">
            ...
            <div class="company-name"><?php echo htmlspecialchars($stationInfo['dealer']); ?></div>
        ...
        <div class="transaction-details">
            ...
            <div class="detail-row">
                <span>Staff ID</span>
                <span><?php echo htmlspecialchars($staffID); ?></span>
            </div>
            <div class="detail-row">
                <span>Payment</span>
        ...
        <div class="items-section">
            ...
            <div class="item-details">
                <?php echo htmlspecialchars($item['category']); ?> | SKU: <?php echo htmlspecialchars($item['sku']); ?> | Size: <?php echo htmlspecialchars($item['size']); ?>
            </div>
            <div class="item-price">
                Qty: <?php echo $item['qty']; ?> x PHP <?php echo number_format($item['unit_price'], 2); ?> = PHP <?php echo number_format($item['amount'], 2); ?>
            </div>
            <?php endforeach; ?>
            <div class="dashed-line"></div>
        </div>
        ...
        <div class="footer">
            ...
            <div class="receipt-note">This serves as your OFFICIAL MERCHANDISE TRANSACTION DOCUMENT</div>
