...
class StationManager {
    ...
    public static function isValidActiveStation($station_id) {
        ...
        try {
            $stmt = $pdo->prepare("SELECT COUNT(*) FROM stations WHERE id = ? AND LOWER(status) = 'active'");
    ...
    public static function getActiveStations() {
        ...
        try {
            $stmt = $pdo->query("SELECT id, name FROM stations WHERE LOWER(status) = 'active' ORDER BY name ASC");
