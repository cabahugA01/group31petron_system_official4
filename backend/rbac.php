...
define('MANAGE_DELIVERIES', 'MANAGE_DELIVERIES');
...
$role_permissions = [
    ...
    'manager' => [
        ...
        // Purchase Orders and Deliveries permissions
...
function hasPermission($permission, $action = 'view') {
    ...
    // Developer has access to database management
    if ($role === 'developer' && $permission === 'database_management') {
        return true;
    }
    
    // Define permission mappings
    $permission_map = [
        'database_management' => ['superadmin', 'developer'],
